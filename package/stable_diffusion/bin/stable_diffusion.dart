...
void main(List<String> args_raw) async {
  Future<Directory?> getPackageDirectory({
    String package_name = "package:stable_diffusion/stable_diffusion.dart",
  }) async {
  ...
  Directory? base_directory_lib = (await getPackageDirectory(package_name: "package:stable_diffusion/stable_diffusion.dart"));
  ...
  String name_exe = "stable_diffusion";
  String help_msg = """
A command-line stable_diffusion.
...
Global options:
  ...
  reload               Reload package stable_diffusion.dart
...
""";
  ...
  if (command == "version") {
    print("stable_diffusion version: 0.0.0 (stable) on ${Platform.operatingSystem}");
    exit(0);
  }
  ...
  if (command == "create") {
    try {
      ...
      if (templates.isEmpty) {
        templates = ["app_stable_diffusion_template"];
      }
