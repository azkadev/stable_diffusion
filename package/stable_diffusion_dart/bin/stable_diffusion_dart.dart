...
void main(List<String> args_raw) async {
  Future<Directory?> getPackageDirectory({
    String package_name =
        "package:stable_diffusion_dart/stable_diffusion_dart.dart",
  }) async {
  ...
  String name_exe = "stable_diffusion_dart";
  String help_msg = """
A command-line stable_diffusion_dart.
...
Global options:
  ...
  reload               Reload package stable_diffusion_dart.dart
...
""";
  ...
  if (command == "version") {
    print(
        "stable_diffusion_dart version: 0.0.0 (stable) on ${Platform.operatingSystem}");
    exit(0);
  }
